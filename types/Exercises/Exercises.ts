...
export enum ExercisesEnum {
  ...
  OTZHIMANYA = "OTHZIMANYA", //Отжимания
  ...
  //TRICEPS
  VERHNII_BLOCK_S_VEREVKOI = "VERHNII_BLOCK_S_VEREVKOI", //Тяга верхнего блока с веревкой
  FRANCUSKII_ZHIM = "FRANCUSKII_ZHIM", //Французский жим
  TYAGA_VERHNEGO_BLOCKA_IZ_ZA_GOLOVI = "TYAGA_VERHNEGO_BLOCKA_IZ_ZA_GOLOVI", //Тяга верхнего блока из-за головы
  VIPRYAMLENIE_RUKI_POD_UGLOM_90_DEG = "VIPRYAMLENIE_RUKI_POD_UGLOM_90_DEG", //Выпрямление руки под углом 90 градусов
  ZHIM_LEZHA_UZSKIM_HVATOM = "ZHIM_LEZHA_UZSKIM_HVATOM", //Жим лежа узским хватом
  ZHIM_GANTELI_IZ_ZA_GOLOVI = "ZHIM_GANTELI_IZ_ZA_GOLOVI", //Жим гантели из-за головы
  OBRATNIE_OTZHIMANIA = "OBRATNIE_OTZHIMANIA", //Обратные отжимания
  OTZHIMANYA_NA_BRUSYAH = "OTZHIMANYA_NA_BRUSYAH", //Отжимания на брусьях
